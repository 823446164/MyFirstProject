...
@Setter
@ToString
@TemplateHeader(id = "ProjectEmployeeList", name = "项目组人员信息", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class ProjectEmployeeList implements Serializable {
