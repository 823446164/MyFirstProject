...
public class EmployeeRankChangeApplyInfoDtoServiceImpl implements EmployeeRankChangeApplyInfoDtoService{
    ...
    public EmployeeRankChangeApplyInfoDtoQueryRsp employeeRankChangeApplyInfoDtoQuery(@Valid EmployeeRankChangeApplyInfoDtoQueryReq employeeRankChangeApplyInfoDtoQueryReq) {
        ...
        BusinessObjectAggregate<BusinessObject> employeeRankChangeApplyInfoDtoQueryRspBoa = bomanager.selectBusinessObjectsBySql("select EI.employeeNo as employeeNo,EI.employeeName as employeeName,EI.employeeAcct as employeeAcct,"
            ...
            +" where 1=1 and ERA.serialNo = :serialNo and EI.employeeNo = :employeeNo","serialNo",employeeRankChangeApplyInfoDtoQueryReq.getSerialNo(),"employeeNo",employeeRankChangeApplyInfoDtoQueryReq.getEmployeeNo());
    ...
    public void employeeRankChangeApplyInfoDtoSaveAction(EmployeeRankChangeApplyInfoDto employeeRankChangeApplyInfoDto){
        ...
        if(employeeRankChangeApplyInfoDto!=null){
            EmployeeRankApply employeeRankApply = bomanager.keyLoadBusinessObject(EmployeeRankApply.class,employeeRankChangeApplyInfoDto.getSerialNo());
