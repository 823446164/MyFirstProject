...
public class EmployeeRank extends BusinessObject {
    ...
    @Description("本次调整额") 
    @Column(name = "currentAdjustPay", precision=24, scale=2) 
    private BigDecimal currentAdjustPay;
     
    public double getDCurrentAdjustPay() {
        return currentAdjustPay == null ? 0.00 : currentAdjustPay.doubleValue();
    }
     
    public void setDCurrentAdjustPay(double currentAdjustPay) {
        this.currentAdjustPay = BigDecimal.valueOf(currentAdjustPay);
    }
}
