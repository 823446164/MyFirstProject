...
@Entity
@Table(
    name="TEST_INFO_JFAN5")
@GeneratedKey(autoGenerateKey=true, allocationSize=1000)
public class TestInfoJfan extends BusinessObject {
    ...
    @Description("毕业时间") 
    @Column(name = "graduationTime",length=30) 
    ...
    @Description("员工现工资") 
    @Column(name = "employeePay", precision=24, scale=2) 
    private double employeePay;
    
    @Description("员工照片") 
    @Column(name = "employeePhoto", length=10000000) 
    private String employeePhoto;
     
//    public double getDEmployeePay() {
//        return employeePay == null ? 0.00 : employeePay.doubleValue();
//    }
//     
//    public void setDEmployeePay(double employeePay) {
