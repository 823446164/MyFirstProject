...
public interface LabelInfoController {
    ...
    @PostMapping(value = "/labelinfo/no", name="标签失效接口", produces=MediaType.APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<ResponseMessage<Object>> lableStatusNo(@Valid RequestMessage<LabelInfoSaveReq> reqMsg);
}
