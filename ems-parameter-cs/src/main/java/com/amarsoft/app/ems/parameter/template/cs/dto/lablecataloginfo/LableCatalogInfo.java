...
@Setter
@ToString
@TemplateHeader(id = "LableCatalogInfo", name = "标签目录详情", type = com.amarsoft.aecd.common.constant.TemplateType.Info, readOnly = false, span = 1)
public class LableCatalogInfo implements Serializable {
