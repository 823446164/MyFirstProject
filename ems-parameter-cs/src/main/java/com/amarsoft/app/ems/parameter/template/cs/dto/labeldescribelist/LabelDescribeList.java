...
@Setter
@ToString
@TemplateHeader(id = "LabelDescribeList", name = "标签能力描述List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class LabelDescribeList implements Serializable {
