...
@Setter
@ToString
@TemplateHeader(id = "LableCatalogList", name = "标签目录树图", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class LableCatalogList implements Serializable {
