...
@Setter
@ToString
@TemplateHeader(id = "EmployeeProjectExpInfo", name = "员工项目经历Info", type = com.amarsoft.aecd.common.constant.TemplateType.Info, readOnly = false, span = 2)
public class EmployeeProjectExpInfo implements Serializable {
