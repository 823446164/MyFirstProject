...
@Setter
@ToString
@TemplateHeader(id = "EmployeeDevelopTargetList", name = "员工成长目标跟踪List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class EmployeeDevelopTargetList implements Serializable {
