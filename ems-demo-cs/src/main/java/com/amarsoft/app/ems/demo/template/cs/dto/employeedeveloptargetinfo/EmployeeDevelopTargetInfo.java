...
@Setter
@ToString
@TemplateHeader(id = "EmployeeDevelopTargetInfo", name = "员工成长目标跟踪Info", type = com.amarsoft.aecd.common.constant.TemplateType.Info, readOnly = false, span = 2)
public class EmployeeDevelopTargetInfo implements Serializable {
    ...
    @Description("目标简述")
    @Length(max=2000)
    @ActualColumn("EDT.targetDescribe")
