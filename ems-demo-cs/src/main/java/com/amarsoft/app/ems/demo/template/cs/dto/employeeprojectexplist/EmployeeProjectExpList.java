...
@Setter
@ToString
@TemplateHeader(id = "EmployeeProjectExpList", name = "员工项目经历List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class EmployeeProjectExpList implements Serializable {
