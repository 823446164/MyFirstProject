...
@Setter
@ToString
@TemplateHeader(id = "EmployeeBelongChangeInfo", name = "团队调整申请Info", type = com.amarsoft.aecd.common.constant.TemplateType.Info, readOnly = false, span = 2)
public class EmployeeBelongChangeInfo implements Serializable {
