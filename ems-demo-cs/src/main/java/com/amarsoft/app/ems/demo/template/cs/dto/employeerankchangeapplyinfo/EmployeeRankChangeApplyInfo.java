...
@Setter
@ToString
@TemplateHeader(id = "EmployeeRankChangeApplyInfo", name = "员工职级调整申请详情Info", type = com.amarsoft.aecd.common.constant.TemplateType.Info, readOnly = false, span = 2)
public class EmployeeRankChangeApplyInfo implements Serializable {
