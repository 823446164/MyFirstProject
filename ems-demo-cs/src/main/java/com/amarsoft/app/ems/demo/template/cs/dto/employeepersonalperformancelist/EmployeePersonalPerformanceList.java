...
@Setter
@ToString
@TemplateHeader(id = "EmployeePersonalPerformanceList", name = "员工项目经历个人表现List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class EmployeePersonalPerformanceList implements Serializable {
