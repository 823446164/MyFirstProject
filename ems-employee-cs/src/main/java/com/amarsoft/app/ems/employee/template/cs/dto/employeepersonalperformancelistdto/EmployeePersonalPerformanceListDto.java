...
import com.amarsoft.aecd.employee.constant.EmployeePersonalPerformance;
...
@Setter
@ToString
@TemplateHeader(id = "EmployeePersonalPerformanceListDto", name = "员工项目经历个人表现List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class EmployeePersonalPerformanceListDto implements Serializable {
    ...
    @Enum(EmployeePersonalPerformance.class)
    @Description("参考因素")
    @Length(max=100)
