...
@Setter
@ToString
@TemplateHeader(id = "EmployeeRankListDto", name = "员工职级List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class EmployeeRankListDto implements Serializable {
