...
@Setter
@ToString
@TemplateHeader(id = "EmployeeRankApplyListDto", name = "员工职级申请List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)
public class EmployeeRankApplyListDto implements Serializable {
