...
@Setter
@ToString
@TemplateHeader(id = "EmployeePersonalPerformanceInfoDto", name = "员工项目经历个人表现Info", type = com.amarsoft.aecd.common.constant.TemplateType.Info, readOnly = false, span = 1)
public class EmployeePersonalPerformanceInfoDto implements Serializable {
