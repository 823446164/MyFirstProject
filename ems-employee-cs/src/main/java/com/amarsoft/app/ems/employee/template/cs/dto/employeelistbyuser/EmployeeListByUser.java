...
@Setter
@ToString
@TemplateHeader(id = "EmployeeListByUserDto", name = "用户权限员工List", type = com.amarsoft.aecd.common.constant.TemplateType.List, readOnly = false, span = 1, export = true)

public class EmployeeListByUser implements Serializable{
